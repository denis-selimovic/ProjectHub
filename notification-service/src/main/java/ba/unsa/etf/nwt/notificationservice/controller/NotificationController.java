...
public class NotificationController {
    ...
    @PostMapping
    public ResponseEntity<Response> create(@RequestBody @Valid CreateNotificationRequest request, ResourceOwner resourceOwner) {
    ...
    public ResponseEntity<Response> delete(@PathVariable UUID notificationId) {
