package ba.unsa.etf.nwt.notificationservice.exception;

import ba.unsa.etf.nwt.notificationservice.exception.base.BaseException;
...
public class ExceptionsHandler extends ResponseEntityExceptionHandler {
    ...
    public static ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex){
        ...
        ex.getBindingResult().getAllErrors().forEach(error -> {
            ...
            errors.put(fieldName, Collections.singletonList(errorMessage));
        });
